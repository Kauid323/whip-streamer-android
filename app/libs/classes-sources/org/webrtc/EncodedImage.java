...
/* loaded from: classes.jar:org/webrtc/EncodedImage.class */
public class EncodedImage implements RefCounted {
    ...
    /* renamed from: qp */
    @Nullable
    public final Integer f1qp;

    /* loaded from: classes.jar:org/webrtc/EncodedImage$FrameType.class */
    ...
    /* loaded from: classes.jar:org/webrtc/EncodedImage$Builder.class */
    public static class Builder {
        ...
        public EncodedImage createEncodedImage() {
            return new EncodedImage(this.buffer, this.releaseCallback, this.encodedWidth, this.encodedHeight, this.captureTimeNs, this.frameType, this.rotation, this.completeFrame, this.f2qp);
        }
    }
}
