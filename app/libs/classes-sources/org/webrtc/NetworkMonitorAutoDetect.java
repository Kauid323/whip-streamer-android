...
/* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect.class */
public class NetworkMonitorAutoDetect extends BroadcastReceiver implements NetworkChangeDetector {
    ...
    /* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect$NetworkState.class */
    ...
    @SuppressLint({"NewApi"})
    /* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect$SimpleNetworkCallback.class */
    private class SimpleNetworkCallback extends ConnectivityManager.NetworkCallback {
        ...
        public void onAvailable(Network network) {
            Logging.m1d(NetworkMonitorAutoDetect.TAG, "Network becomes available: " + network.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onCapabilitiesChanged(Network network, NetworkCapabilities networkCapabilities) {
            Logging.m1d(NetworkMonitorAutoDetect.TAG, "capabilities changed: " + networkCapabilities.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLinkPropertiesChanged(Network network, LinkProperties linkProperties) {
            Logging.m1d(NetworkMonitorAutoDetect.TAG, "link properties changed: " + linkProperties.toString());
            onNetworkChanged(network);
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLosing(Network network, int maxMsToLive) {
            Logging.m1d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is about to lose in " + maxMsToLive + "ms");
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onLost(Network network) {
            Logging.m1d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " is disconnected");
    ...
    /* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect$ConnectivityManagerDelegate.class */
    static class ConnectivityManagerDelegate {
        ...
        NetworkState getNetworkState(@Nullable Network network) {
            ...
            if (networkInfo == null) {
                Logging.m3w(NetworkMonitorAutoDetect.TAG, "Couldn't retrieve information from network " + network.toString());
                return new NetworkState(false, -1, -1, -1, -1);
            }
        ...
        public NetworkChangeDetector.NetworkInformation networkToInfo(@Nullable Network network) {
            ...
            if (linkProperties == null) {
                Logging.m3w(NetworkMonitorAutoDetect.TAG, "Detected unknown network: " + network.toString());
                return null;
            }
            if (linkProperties.getInterfaceName() == null) {
                Logging.m3w(NetworkMonitorAutoDetect.TAG, "Null interface name for network " + network.toString());
                return null;
            }
            ...
            if (connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN || connectionType == NetworkChangeDetector.ConnectionType.CONNECTION_UNKNOWN_CELLULAR) {
                Logging.m1d(NetworkMonitorAutoDetect.TAG, "Network " + network.toString() + " connection type is " + connectionType + " because it has type " + networkState.getNetworkType() + " and subtype " + networkState.getNetworkSubType());
            }
        ...
        public void releaseCallback(ConnectivityManager.NetworkCallback networkCallback) {
            if (supportNetworkCallback()) {
                Logging.m1d(NetworkMonitorAutoDetect.TAG, "Unregister network callback");
    ...
    /* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect$WifiManagerDelegate.class */
    ...
    /* loaded from: classes.jar:org/webrtc/NetworkMonitorAutoDetect$WifiDirectManagerDelegate.class */
    static class WifiDirectManagerDelegate extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) throws SocketException {
        ...
        private void onWifiP2pGroupChange(@Nullable WifiP2pGroup wifiP2pGroup) throws SocketException {
            ...
            try {
                ...
                Logging.m4e(NetworkMonitorAutoDetect.TAG, "Unable to get WifiP2p network interface", e);
            }
        }
    ...
    public NetworkMonitorAutoDetect(NetworkChangeDetector.Observer observer, Context context) {
        ...
        if (this.connectivityManagerDelegate.supportNetworkCallback()) {
            ...
            try {
                ...
                Logging.m3w(TAG, "Unable to obtain permission to request a cellular network.");
    ...
    private void connectionTypeChanged(NetworkState networkState) {
        ...
        Logging.m1d(TAG, "Network connectivity changed, type is: " + this.connectionType);
