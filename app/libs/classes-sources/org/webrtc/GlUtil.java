...
/* loaded from: classes.jar:org/webrtc/GlUtil.class */
public class GlUtil {
    private GlUtil() {
    }

    /* loaded from: classes.jar:org/webrtc/GlUtil$GlOutOfMemoryException.class */
    ...
    public static void checkNoGLES2Error(String msg) {
        ...
        if (error != 0) {
            if (error == 1285) {
                throw new GlOutOfMemoryException(msg);
            }
